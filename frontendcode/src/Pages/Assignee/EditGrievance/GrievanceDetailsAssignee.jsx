    ...
    const fetchGrievance = async () => {
      try {
        ...
        if (Array.isArray(response.data)) {
          ...
          setGrievanceDetails([response.data.data]); // Wrap the data in an array
        }
      } catch (error) {
              ...
              <>
                ...
                <div className="row_details">
                  <div className="reason_details">
                    ...
                    <div className="value_reason">{grievanceDetails[0].reason}</div>
                  </div>
                  <div className="description_details">
                    <div className='label_description'>Description</div>
                    <div className="seperator_description">:</div>
                    <div className="value_description">{grievanceDetails[0].description}</div>
                  </div>
                </div>
                <div className="row_details">
                  <div className="phone_no_details">
                    ...
                    <div className="value_phone_no">{grievanceDetails[0].phoneNumber}</div>
                  </div>
                  <div className="address_details">
                    <div className='label_address'>Address</div>
                    <div className="seperator_address">:</div>
                    <div className="value_address">{grievanceDetails[0].address}</div>
                  </div>
                </div>
                <div className="row_details">
                  <div className="invoice_date_details">
                    ...
                    <div className="value_invoice_date">{grievanceDetails[0].createdAt}</div>
                  </div>
                </div>
                <div className="row_details">
